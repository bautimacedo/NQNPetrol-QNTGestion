...
<div class="space-y-6">
    ...
    <form action="{{ route('production.missions.store') }}" method="POST" class="bg-gray-800 rounded-lg border border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-400 mb-2">Dron</label>
        ...
        <div class="flex justify-end gap-4 pt-6 border-t border-gray-700 mt-6">
            ...
            <button type="submit" class="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg">Registrar Misión</button>
        </div>
    </form>
</div>
@endsection
